...
const SideBar = () => {
  return (
    <div>
      {/* <div className="bg-gray-100 h-auto w-auto space-y-4 my-10 py-5 px-10 rounded-lg max-w-xs">
        ...
        <div>
          <div className="flex flex-row space-x-4 ">
            <RiLogoutCircleLine className="text-lime-500" />
            <h3 className="text-green-500">Log out</h3>
          </div>
        </div>
      </div> */}
            ...
            <ul class="flex flex-col py-4 space-y-1">
              ...
              <li>
                ...
                >
                  ...
                  <span class="ml-2 text-sm tracking-wide truncate">Shop</span>
                </a>
              </li>
              <li>
                <a
